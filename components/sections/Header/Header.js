...
export default function Header() {
  ...
  return (
    <React.Fragment>
      <chakra.header h="full" bg={bg} w="full" px={{ base: 10, sm: 20 }} py={4}>
        <Flex alignItems="center" justifyContent="space-between" mx="auto">
          ...
          <Box display="flex" alignItems="center">
            <IconButton
              ...
              icon={<SwitchIcon />}
            />
            <HStack display={{ base: "none", md: "inline-flex" }} spacing={1}>
              <Button colorScheme="brand" variant="ghost" size="md">
                Sign in
              </Button>
            </HStack>
            <IconButton
